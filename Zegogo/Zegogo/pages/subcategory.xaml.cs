...
namespace Zegogo.pages
{
	...
	public partial class subcategory : ContentPage , IAnimationPage
	{
		public string subId;
		...
		public subcategory(ListCategory listCategory, string title, string subId)
		{
			InitializeComponent();
			this.subId = subId;
			...
			{
				SubTitle.Text = title;
				allInTitle.Text = AppResources.all_in_cat + " " + title;
			}
		...
		private async void TapGestureRecognizer_Tapped_1(object sender, EventArgs e)
		{
			...
			await(sender as Frame).ScaleTo(1.1, 50);
			await(sender as Frame).ScaleTo(1, 50);
			MessagingCenter.Send<string>(subId, "LabelChange");
			await Navigation.PopToRootAsync();
		}
	}
}